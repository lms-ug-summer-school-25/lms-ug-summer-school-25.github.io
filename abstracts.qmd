...
| | Abstract: A decision problem asks whether there can be an algorithm for deciding
the answer to some family of yes/no questions.  Topology is the branch
of topology in which you ignore distance and you are allowed to distort
or stretch things without breaking them.
I'll describe some questions in topology where there is an algorithm to
answer them, some where there cannot be any algorithm, and some where
